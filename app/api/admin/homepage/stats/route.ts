...
export const GET = withApiErrors(async (req: Request) => {
  ...
  // Les compteurs de sections sont propres au groupe de pages consulté ;
  // les vues et l'engagement restent ceux de l'accueil, seule page dont la
  // fréquentation est mesurée.
  ...
  const [sectionsTotal, sectionsActive, pinnedTotal, pinnedActive, viewStats, engagementRatePct] = await Promise.all([
    HomepageSection.countDocuments({ page }),
    HomepageSection.countDocuments({ page, enabled: true }),
